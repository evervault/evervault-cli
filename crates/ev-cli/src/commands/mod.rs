...
pub enum EnclaveCommand {
    ...
    Dev(ev_enclave::cli::dev::DevArgs),
    ...
    #[cfg(feature = "internal_dependency")]
    Env(ev_enclave::cli::env::EnvArgs),
    #[cfg(feature = "internal_dependency")]
    Encrypt(ev_enclave::cli::encrypt::EncryptArgs),
...
pub async fn run_enclave(args: EnclaveArgs) -> i32 {
    match args.action {
        ...
        #[cfg(feature = "internal_dependency")]
        EnclaveCommand::Dev(dev_args) => cli::dev::run(dev_args).await,
        ...
        #[cfg(feature = "internal_dependency")]
        EnclaveCommand::Env(env_args) => cli::env::run(env_args).await,
        #[cfg(feature = "internal_dependency")]
        EnclaveCommand::Encrypt(env_args) => cli::encrypt::run(env_args).await,
