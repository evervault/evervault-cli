use crate::enclave::{
    ...
    cert,
    common::OutputPath,
    config::{read_and_validate_config, ValidatedEnclaveBuildConfig},
    nitro::BuiltEnclave,
};
...
pub async fn build_test_enclave(
    ...
    let dn_string = cert::DistinguishedName::default();
    cert::create_new_cert(std::path::Path::new("."), dn_string)
