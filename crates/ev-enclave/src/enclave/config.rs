...
use super::nitro::{EIFMeasurements, EnclaveSigningInfo};
use crate::enclave::api;
use crate::enclave::cert::{get_cert_validity_period, CertValidityPeriod};
...
impl EnclaveConfig {
    pub fn annotate(&mut self, enclave: api::enclave::Enclave) {
